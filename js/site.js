...
function initFAQ() {
    ...
    const arr = [
        {
            question: 'What is Weidiansheet?',
            answer: 'Weidiansheet is in a sense, a spreadsheet made easy.We combine the best element’s of spreadsheets and top of the line website UI to make your shopping experience very easy.'
        },
        {
        ...
        },
        {
            ...
            answer: 'Weidiansheet allows for the easiest finding & buying experience for new and veteran replica buyers. With thousands of finds, you’ll never need to go anywhere else.'
        },
        {
...
function initFooter() {
    ...
    if (!footer) return
    const arr = [
        'Weidiansheet.com does not sell any physical products and neither does Weidian.',
...
//       buy[i].innerHTML = 'View details and Buy on Weidian'
//     }
//   }
// }
