...
function initFAQ() {
    ...
    const arr = [
        {
            question: 'What is Mulebuysheet?',
            answer: 'Mulebuysheet is in a sense, a spreadsheet made easy.We combine the best element’s of spreadsheets and top of the line website UI to make your shopping experience very easy.'
        },
        {
        ...
        },
        {
            ...
            answer: 'Mulebuysheet allows for the easiest finding & buying experience for new and veteran replica buyers. With thousands of finds, you’ll never need to go anywhere else.'
        },
        {
...
function initFooter() {
    ...
    if (!footer) return
    const arr = [
        'Mulebuysheet.com does not sell any physical products and neither does Mulebuy.',
...
//       buy[i].innerHTML = 'View details and Buy on Mulebuy'
//     }
//   }
// }
